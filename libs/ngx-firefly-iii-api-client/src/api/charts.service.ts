...
export class ChartsService {
     ...
     */
    public getChartAccountOverview(start: string, end: string, xTraceId?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<ChartDataSet>>;
    public getChartAccountOverview(start: string, end: string, xTraceId?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<ChartDataSet>>>;
    public getChartAccountOverview(start: string, end: string, xTraceId?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<ChartDataSet>>>;
    public getChartAccountOverview(start: string, end: string, xTraceId?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        return this.httpClient.request<Array<ChartDataSet>>('get', `${this.configuration.basePath}${localVarPath}`,
            {
