...
export const BillRepeatFrequency = {
    Weekly: 'weekly' as BillRepeatFrequency,
    Monthly: 'monthly' as BillRepeatFrequency,
    Quarterly: 'quarterly' as BillRepeatFrequency,
    HalfYear: 'half-year' as BillRepeatFrequency,
    Yearly: 'yearly' as BillRepeatFrequency
};
