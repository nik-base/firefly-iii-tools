...
export const InterestPeriodProperty = {
    Weekly: 'weekly' as InterestPeriodProperty,
    Monthly: 'monthly' as InterestPeriodProperty,
    Quarterly: 'quarterly' as InterestPeriodProperty,
    HalfYear: 'half-year' as InterestPeriodProperty,
    Yearly: 'yearly' as InterestPeriodProperty,
    Null: 'null' as InterestPeriodProperty
};
