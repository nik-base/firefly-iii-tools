 ...
 */
export type WebhookResponse = 'TRANSACTIONS' | 'ACCOUNTS' | 'NONE';

export const WebhookResponse = {
    Transactions: 'TRANSACTIONS' as WebhookResponse,
    Accounts: 'ACCOUNTS' as WebhookResponse,
    None: 'NONE' as WebhookResponse
};
