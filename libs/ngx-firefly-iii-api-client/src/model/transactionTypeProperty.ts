...
export const TransactionTypeProperty = {
    Withdrawal: 'withdrawal' as TransactionTypeProperty,
    Deposit: 'deposit' as TransactionTypeProperty,
    Transfer: 'transfer' as TransactionTypeProperty,
    Reconciliation: 'reconciliation' as TransactionTypeProperty,
    OpeningBalance: 'opening balance' as TransactionTypeProperty
};
