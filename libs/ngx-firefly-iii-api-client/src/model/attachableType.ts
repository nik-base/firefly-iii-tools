...
export const AttachableType = {
    Account: 'Account' as AttachableType,
    Budget: 'Budget' as AttachableType,
    Bill: 'Bill' as AttachableType,
    TransactionJournal: 'TransactionJournal' as AttachableType,
    PiggyBank: 'PiggyBank' as AttachableType,
    Tag: 'Tag' as AttachableType
};
