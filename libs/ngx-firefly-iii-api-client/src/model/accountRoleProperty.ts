...
export const AccountRoleProperty = {
    DefaultAsset: 'defaultAsset' as AccountRoleProperty,
    SharedAsset: 'sharedAsset' as AccountRoleProperty,
    SavingAsset: 'savingAsset' as AccountRoleProperty,
    CcAsset: 'ccAsset' as AccountRoleProperty,
    CashWalletAsset: 'cashWalletAsset' as AccountRoleProperty,
    Null: 'null' as AccountRoleProperty
};
