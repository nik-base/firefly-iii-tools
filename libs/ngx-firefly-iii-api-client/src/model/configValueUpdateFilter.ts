...
export const ConfigValueUpdateFilter = {
    IsDemoSite: 'configuration.is_demo_site' as ConfigValueUpdateFilter,
    PermissionUpdateCheck: 'configuration.permission_update_check' as ConfigValueUpdateFilter,
    LastUpdateCheck: 'configuration.last_update_check' as ConfigValueUpdateFilter,
    SingleUserMode: 'configuration.single_user_mode' as ConfigValueUpdateFilter
};
