...
export const AccountSearchFieldFilter = {
    All: 'all' as AccountSearchFieldFilter,
    Iban: 'iban' as AccountSearchFieldFilter,
    Name: 'name' as AccountSearchFieldFilter,
    Number: 'number' as AccountSearchFieldFilter,
    Id: 'id' as AccountSearchFieldFilter
};
