...
export const AutoBudgetPeriod = {
    Daily: 'daily' as AutoBudgetPeriod,
    Weekly: 'weekly' as AutoBudgetPeriod,
    Monthly: 'monthly' as AutoBudgetPeriod,
    Quarterly: 'quarterly' as AutoBudgetPeriod,
    HalfYear: 'half-year' as AutoBudgetPeriod,
    Yearly: 'yearly' as AutoBudgetPeriod,
    Null: 'null' as AutoBudgetPeriod
};
